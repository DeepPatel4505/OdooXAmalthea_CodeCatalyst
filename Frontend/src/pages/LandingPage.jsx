...
import { PageWrapper, AnimatedButton, AnimatedCard } from "@/components/ui/animations";
import {
  Receipt,
  Users,
  Shield,
...
export function LandingPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Instant expense submission and approval workflows for better management",
    },
    {
    ...
    <PageWrapper>
        ...
        <header className="border-b bg-background/80 backdrop-blur-sm sticky top-0 z-50">
          <div className="container mx-auto px-4 py-4 flex items-center justify-between">
            ...
            >
              ...
              <AnimatedButton
                onClick={() => navigate("/login")}
                className="bg-gradient-to-r from-primary to-secondary hover:from-primary-600 hover:to-secondary-600 text-white font-medium"
              >
                Get Started
              </AnimatedButton>
            </motion.div>
      ...
      <section className="py-20 px-4 transition-all duration-500">
        <div className="container mx-auto text-center max-w-4xl">
          ...
          <motion.h1 
            className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-foreground via-blue-900 to-indigo-900 bg-clip-text text-transparent"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <AnimatedButton
              size="lg"
              onClick={() => navigate("/login")}
              className="bg-gradient-to-r from-primary to-secondary hover:from-primary-700 hover:to-secondary-700 text-lg px-8 py-3"
              variant="primary"
            >
              Start Free Trial
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <AnimatedCard
                  className="p-6 transition-all duration-300 border-0 shadow-md bg-card/50 backdrop-blur-sm hover:bg-card/80"
                >
                  <div className="flex items-center mb-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-primary-100 to-indigo-100 dark:from-primary-900/30 dark:to-indigo-900/30 rounded-lg flex items-center justify-center text-primary-600 dark:text-primary-400 mr-4">
                      {feature.icon}
                    </div>
